...
def main(opt):
    ...
    # path = opt.dataroot
    path = os.path.join(ROOT_FOLDER, 'ABIDE_pcp/cpac/filt_noglobal')
    name = 'ABIDE'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataroot', type=str, default=os.path.join(ROOT_FOLDER, 'ABIDE_pcp/cpac/filt_noglobal'), help='root directory of the dataset')
